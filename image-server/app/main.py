...
def generate_image(payload: GenerateImageRequest) -> GenerateImageResponse: return GenerateImageResponse(
  # For now, every reqeust returns the same fake image url
